...
function addSignalCommonFilters(
  filters: LogsFilter | MetricsFilter | ScoresFilter | FeedbackFilter | undefined,
  ...
  addEq(col('entityType'), (filters as LogsFilter | MetricsFilter).entityType, 'entityType', 'String', out);
  addEq(col('entityName'), (filters as LogsFilter | MetricsFilter).entityName, 'entityName', 'String', out);
  addEq(
    col('parentEntityType'),
    (filters as LogsFilter | MetricsFilter).parentEntityType,
    'parentEntityType',
    'String',
    out,
  );
  addEq(
    col('parentEntityName'),
    (filters as LogsFilter | MetricsFilter).parentEntityName,
    'parentEntityName',
    'String',
    out,
  );
  addEq(col('rootEntityType'), (filters as LogsFilter | MetricsFilter).rootEntityType, 'rootEntityType', 'String', out);
  addEq(col('rootEntityName'), (filters as LogsFilter | MetricsFilter).rootEntityName, 'rootEntityName', 'String', out);
  addEq(col('userId'), (filters as LogsFilter | MetricsFilter | FeedbackFilter).userId, 'userId', 'String', out);
  ...
  addEq(col('resourceId'), (filters as LogsFilter | MetricsFilter).resourceId, 'resourceId', 'String', out);
  addEq(col('runId'), (filters as LogsFilter | MetricsFilter).runId, 'runId', 'String', out);
  addEq(col('sessionId'), (filters as LogsFilter | MetricsFilter).sessionId, 'sessionId', 'String', out);
  addEq(col('threadId'), (filters as LogsFilter | MetricsFilter).threadId, 'threadId', 'String', out);
  addEq(col('requestId'), (filters as LogsFilter | MetricsFilter).requestId, 'requestId', 'String', out);
  addEq(col('serviceName'), (filters as LogsFilter | MetricsFilter).serviceName, 'serviceName', 'String', out);
  addEq(col('environment'), (filters as LogsFilter | MetricsFilter).environment, 'environment', 'String', out);
  addEq(col('source'), (filters as LogsFilter | MetricsFilter | FeedbackFilter).source, 'source', 'String', out);
  addTags(col('tags'), (filters as LogsFilter | MetricsFilter).tags, out);
}
